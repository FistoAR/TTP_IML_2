...
export default function ScreenPrintingOrderDetails({
  ...
  const isOrderMovedToScreenPrinting = () => {
    if (
      ...
      existingOrder.products.length === 0
    )
      return false;

    // Check if ALL products in the existing order have been moved to screen printing
    return existingOrder.products.every((p) => p.moveToScreenPrinting === true);
  };
  ...
  const [products, setProducts] = useState([
    {
      ...
      tubColor: "white",
      printType: "LID", // Default to LID
      // Separate color fields for LID
      lidPrintingColor1: "",
      lidPrintingColor2: "",
      lidPrintingColor3: "",
      // Separate color fields for TUB
      tubPrintingColor1: "",
      tubPrintingColor2: "",
      tubPrintingColor3: "",
      lidLabelQty: "",
    ...
    if (existingOrder) {
      ...
      if (existingOrder.products && Array.isArray(existingOrder.products)) {
        const mappedProducts = existingOrder.products.map((product, index) => ({
          ...
          // Handle LID colors (backward compatibility with old data)
          lidPrintingColor1:
            product.lidPrintingColor1 || product.printingColor1 || "",
          lidPrintingColor2:
            product.lidPrintingColor2 || product.printingColor2 || "",
          lidPrintingColor3:
            product.lidPrintingColor3 || product.printingColor3 || "",
          // Handle TUB colors (backward compatibility with old data)
      ...
      try {
        ...
        if (ordersData) {
          ...
          const foundOrder = allOrders.find(
            (order) => order.orderNumber === params.orderNumber,
          );
          ...
          if (foundOrder) {
            ...
            if (isRestock) {
              ...
              console.log(
                "Restock - Generating new order number:",
                orderNumberToShow,
              );
            } else {
              ...
              console.log(
                "Edit mode - Showing original order number:",
                orderNumberToShow,
              );
            }
            ...
            const paymentRecordsToUse = isRestock
              ? []
              : foundOrder.paymentRecords || [];

            // Set products (copy from original)
            if (foundOrder.products && Array.isArray(foundOrder.products)) {
              const mappedProducts = foundOrder.products.map(
                (product, index) => ({
                  id: product.id || index + 1,
                  productName: product.productName || "",
                  size: product.size || "",
  ...
  const saveToLocalStorage = (orderData, isRestock) => {
    try {
      ...
      if (isRestock || orderData._isNewOrder) {
        ...
        alert(
          `Order ${isRestock ? "restocked" : "created"}: ${orderData.orderNumber}`,
        );
      } else {
  ...
  const addPaymentRecord = () => {
    ...
    const newRecord = {
      ...
      file: bulkPayment.file, // Persist File object
      ...
      <div className="max-w-[90vw] mx-auto bg-white rounded-[0.8vw] shadow-sm pb-[.75vw]">
        ...
        <div className="flex justify-between items-baseline p-[1vw_1.5vw] border-b border-gray-200">
          ...
          <h1 className="text-[1.5vw] font-semibold text-gray-800 m-0">
            Orders/Screen Printing Details
          </h1>
        </div>
                    ...
                    <div className="bg-white rounded-[0.6vw] border-2 border-blue-200 p-[1vw] mb-[1vw]">
                      ...
                      <div className="grid grid-cols-4 gap-[1.5vw] mt-[1vw]">
                        ...
                        <Input
                          ...
                          disabled={isOrderMovedToScreenPrinting()}
                        />
                      </div>
                        ...
                        {product.printType === "LID & TUB" ? (
                          <>
                            ...
                            <div className="mb-[1vw]">
                              ...
                              <div className="grid grid-cols-4 gap-[1.5vw] mt-[0.5vw]">
                                <div>
                                  <label className="block text-[0.85vw] font-medium text-gray-700 mb-[0.5vw]">
                                    Color 1
                                  </label>
                                  <AutocompleteInput
                                    value={product.lidPrintingColor1}
                                    onChange={(value) =>
                                      updateProduct(
                                        product.id,
                                        "lidPrintingColor1",
                                    ...
                                    placeholder="Select LID color 1"
                                  />
                                </div>
                                <div>
                                  <label className="block text-[0.85vw] font-medium text-gray-700 mb-[0.5vw]">
                                  ...
                                  <AutocompleteInput
                                    value={product.lidPrintingColor2}
                                    onChange={(value) =>
                                      updateProduct(
                                        product.id,
                                        "lidPrintingColor2",
                                    ...
                                    options={PRINTING_COLOR_OPTIONS}
                                    placeholder="Select LID color 2"
                                  />
                                </div>
                                <div>
                                  <label className="block text-0.85vw font-medium text-gray-700 mb-0.5vw">
                                  ...
                                  <AutocompleteInput
                                    value={product.lidPrintingColor3}
                                    onChange={(value) =>
                                      updateProduct(
                                        product.id,
                                        "lidPrintingColor3",
                                    ...
                                    options={PRINTING_COLOR_OPTIONS}
                                    placeholder="Select LID color 3"
                                  />
                                </div>
                              </div>
                            </div>
                            ...
                            <div>
                              ...
                              <div className="grid grid-cols-4 gap-[1.5vw] mt-[0.5vw]">
                                <div>
                                  ...
                                  <AutocompleteInput
                                    value={product.tubPrintingColor1}
                                    onChange={(value) =>
                                      updateProduct(
                                        product.id,
                                        "tubPrintingColor1",
                                    ...
                                    options={PRINTING_COLOR_OPTIONS}
                                    placeholder="Select TUB color 1"
                                  />
                                </div>
                                <div>
                                  <label className="block text-[0.85vw] font-medium text-gray-700 mb-[0.5vw]">
                                  ...
                                  <AutocompleteInput
                                    value={product.tubPrintingColor2}
                                    onChange={(value) =>
                                      updateProduct(
                                        product.id,
                                        "tubPrintingColor2",
                                    ...
                                    options={PRINTING_COLOR_OPTIONS}
                                    placeholder="Select TUB color 2"
                                  />
                                </div>
                                <div>
                                  <label className="block text-0.85vw font-medium text-gray-700 mb-0.5vw">
                                  ...
                                  <AutocompleteInput
                                    value={product.tubPrintingColor3}
                                    onChange={(value) =>
                                      updateProduct(
                                        product.id,
                                        "tubPrintingColor3",
                                    ...
                                    options={PRINTING_COLOR_OPTIONS}
                                    placeholder="Select TUB color 3"
                                  />
                                </div>
                              </div>
                            </div>
                          </>
                        ) : product.printType === "LID" ? (
                          <>
                            <p className="text-[0.9vw] font-medium text-blue-900">
                              LID Printing Color
                            </p>
                    ...
                    <tbody>
                      {paymentRecords.map((record) => (
                        ...
                        >
                          ...
                          <td className="px-[1vw] py-[0.7vw] text-right text-[0.8vw]">
                            {record.file ? (
