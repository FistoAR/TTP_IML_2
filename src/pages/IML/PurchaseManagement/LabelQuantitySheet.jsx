...
const LabelQuantitySheet = () => {
  ...
  const handleSave = (finalizeProduct = false) => {
    ...
    if (currentProduct.imlType === "LID & TUB") {
      ...
      if (currentProduct.lidLabelQty < lidVal) {
        alert("Please enter a valid lid quantity");
        return;
      }
      if (currentProduct.tubLabelQty < tubVal) {
        alert("Please enter a valid tub quantity");
        return;
      }
      ...
      if ((currentProduct.lidLabelQty || currentProduct.tubLabelQty) < qtyVal) {
