...
export default function SalesPaymentDetails() {
  ...
  const calculateTotals = () => {
    if (!billData) return { totalQuantity: 0, totalSamples: 0 };
    ...
    return { totalQuantity, totalSamples };
  };
              ...
              <div className="flex items-center gap-[0.75vw]">
                ...
                <div>
                  ...
                  <p className="text-[0.85vw] text-green-600 mt-[0.25vw]">
                    ...
                    department. Estimated Value: ₹{billData.estimatedValue.toLocaleString()}
                  </p>
                </div>
              </div>
            </div>
