  ...
  const ViewRequestModal = () => {
              ...
              ? {
                ...
                invoices: [
                  ...(o.invoices || []),
                  {
                    ...
                    imlName: currentProduct.imlName || currentProduct.imlName,
                    imlType: currentProduct.imlType || currentProduct.imlType,
                    lidColor: currentProduct.lidColor || currentProduct.lidColor,
    ...
    return (
      <div className="fixed inset-0 bg-[#000000b3] z-[50001] flex items-center justify-center p-[1.5vw]">
        <div className="bg-white rounded-[1vw] max-w-[60vw] w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="bg-white rounded-lg max-w-md w-full p-6">
              ...
              <div className="mb-6">
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  {(currentProduct.changeRequests[remarksModal.requestIndex]
                ...
                <textarea
                 ...
                 placeholder={
                    remarksModal.action === "accept" &&
                    currentProduct.changeRequests[remarksModal.requestIndex]?.type === "delete"
                      ? "Enter Invoice Details"
                      : "Enter Remarks"
                  }
                  rows={4}
    ...
    return (
      <div className="fixed inset-0 bg-[#000000b3] z-[50005] flex items-center justify-center p-4">
        <div className="bg-white rounded max-w-4xl w-full max-h-[90vh] overflow-y-auto">
          {/* HEADER */}
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white p-[1vw] rounded">
            <div className="flex items-center justify-between">
              <div>
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-gray-100 text-gray-700 text-sm font-semibold border-b border-gray-200">
                      <th className="p-4 whitespace-nowrap  border-r border-gray-400 border-b">S. No.</th>
                      <th className="p-4 whitespace-nowrap  border-r border-gray-400 border-b">Product Name</th>
                      <th className="p-4 whitespace-nowrap  border-r border-gray-400 border-b">Product Size</th>
                      <th className="p-4 whitespace-nowrap  border-r border-gray-400 border-b">IML Name</th>
                      <th className="p-4 whitespace-nowrap  border-r border-gray-400 border-b">Invoice Details</th>
                                                              ...
                                                              "Artwork Approved") && (
                                                                <>
                                                                  <button
                                                                    onClick={() =>
                                                                      {
                                                                        const confirm1 = confirm("Do you want to set this product status as Artwork Pending?")
                                                                        if (confirm1) {
