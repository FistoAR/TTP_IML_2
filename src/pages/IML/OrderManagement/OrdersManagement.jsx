...
const [deletedOrderInvoicesModal, setDeletedOrderInvoicesModal] = useState({ 
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white p-8 rounded-t-2xl">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="text-white hover:bg-white hover:bg-opacity-20 rounded-2xl w-14 h-14 flex items-center justify-center text-2xl font-bold transition-all"
              >
                ×
              </button>
            </div>
  ...
  return (
    ...
    >
      ...
      {deletedOrderInvoicesModal.isOpen && (
  <div className="fixed inset-0 bg-[#000000b3] z-[50009] flex items-center justify-center p-4">
    <div className="bg-white rounded-2xl max-w-5xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
      ...
      <div className="bg-gradient-to-r from-gray-800 to-gray-900 text-white p-8 rounded-t-2xl">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="opacity-90 text-lg">
              Order: <strong>{deletedOrderInvoicesModal.orderNumber}</strong>
            </p>
          </div>
          <button
            onClick={() => setDeletedOrderInvoicesModal({ isOpen: false, orderId: null, orderNumber: null, invoices: [] })}
            className="text-white hover:bg-white hover:bg-opacity-20 rounded-2xl w-14 h-14 flex items-center justify-center text-2xl"
          >
            ×
          </button>
        </div>
      ...
      <div className="p-8">
          ...
          <table className="w-full border-collapse bg-white rounded-xl shadow-sm">
            <thead>
              <tr className="bg-gradient-to-r from-blue-600 to-blue-700 text-white">
                <th className="p-4 text-left font-black rounded-tl-xl">Invoice No</th>
                <th className="p-4 text-left font-black">Product</th>
                <th className="p-4 text-center font-black">Date</th>
                <th className="p-4 text-right font-black rounded-tr-xl">Amount (₹)</th>
              </tr>
            </thead>
            <tbody>
              {deletedOrderInvoicesModal.invoices.length === 0 ? (
                <tr>
                  <td colSpan={4} className="p-12 text-center text-gray-500">
                    No invoices found for this deleted order
                  </td>
                </tr>
              ) : (
                deletedOrderInvoicesModal.invoices.map((invoice, index) => (
                  <tr key={invoice.id} className="hover:bg-gray-50 border-b last:border-b-0">
                    <td className="p-4 font-bold text-blue-600">{invoice.invoiceNo}</td>
                    <td className="p-4">
                      <div className="font-semibold">{invoice.productName}</div>
                      <div className="text-sm text-gray-600">{invoice.size}</div>
                    </td>
        ...
        {/* TOTALS */}
        {deletedOrderInvoicesModal.invoices.length > 0 && (
          <div className="mt-8 p-6 bg-gradient-to-r from-emerald-50 to-green-50 rounded-2xl border-4 border-emerald-200">
            <div className="flex justify-between items-center">
              <span className="text-2xl font-black text-gray-900">TOTAL INVOICES</span>
        ...
        <div className="flex justify-end mt-12 pt-8 border-t-4 border-gray-200">
          <button
            onClick={() => setDeletedOrderInvoicesModal({ isOpen: false, orderId: null, orderNumber: null, invoices: [] })}
            className="px-12 py-4 bg-gradient-to-r from-gray-500 to-gray-600 text-white rounded-2xl hover:shadow-xl font-black text-lg transition-all"
          >
            Close
          </button>
        </div>
