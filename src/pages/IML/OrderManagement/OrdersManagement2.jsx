                  ...
                  >
                    ...
                    {request.status && (
                      <div className="mt-[1vw] p-[1vw] bg-gray-100 rounded-[0.5vw] text-[0.85vw] border">
                        ...
                        {request.remarks && (
                          <p className="mt-[0.25vw] text-[.7vw] text-gray-700 bg-white p-[0.5vw] rounded-[0.25vw] mt-[0.5vw]">
                            {request.remarks}
                          </p>
                        )}
                      </div>
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-gray-100 text-gray-700 text-sm font-semibold border-b border-gray-200">
                      ...
                      <th className="p-4 whitespace-nowrap  border-r border-gray-400 border-b">Product</th>
                      <th className="p-4 whitespace-nowrap  border-r border-gray-400 border-b">Remarks</th>
                  ...
                  <tbody className="text-sm text-gray-600 divide-y divide-gray-100">
                    {orders
                      ...
                      .map((invoice, i) => (
                        ...
                        >
                          <td className="p-4 font-medium text-gray-900 border-r border-gray-400">
                          ...
                          <td className="p-4 max-w-[.85vw] truncate border-r border-gray-400" title={invoice.remarks}>
                            {invoice.remarks || "-"}
                          </td>
      ...
      <>
        <div className="fixed inset-0 bg-black/60 z-[50010] flex items-center justify-center p-[1.5vw]">
          <div className="bg-white rounded-[1.8vw] max-w-[92vw] w-full max-h-[85vh] overflow-hidden shadow-2xl flex flex-col">
            ...
            {/* TABS - Only 2 tabs */}
            <div className="bg-[#ad6262] text-white p-[1.8vw] rounded-t-[1.8vw]">
