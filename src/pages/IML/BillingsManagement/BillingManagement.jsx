...
const BillingManagement = () => {
  ...
  try {
    ...
    // ADD THIS SORTING - Latest entries first
    ...
    // Make sure to use sortedRecords here too
      ...
      <div className="max-w-[95vw] mx-auto">
        ...
        <div className="bg-white rounded-[0.8vw] shadow-sm mb-[1vw] p-[1.5vw]">
          <div className="flex justify-between items-center mb-[1vw]">
            <div>
              ...
              <p className="text-[0.85vw] text-gray-600 mt-[0.3vw]">
                Manage individual bills from Sales Payment
              </p>
            </div>
          ...
          <div className="relative">
            <input
              type="text"
              placeholder="Search by company, order, contact, or IML name..."
              value={searchTerm}
          ...
          {Object.keys(groupedData).length === 0 ? (
            <div className="bg-white rounded-[0.8vw] shadow-sm p-[3vw] text-center">
              ...
              <p className="text-[0.9vw] text-gray-500">
                Bills will appear here once orders are sent from Sales Payment
              </p>
            </div>
          ) : (
